                  ...
                  @foreach($books as $book)
                    ...
                    <tr>
                      ...
                      <td style="display:flex; gap:5px; justify-content:center;">
                        <a href="{{ route('editor.etude.view', $book->booksID) }}" class="btn btn-warning btn-xs"
                          data-toggle="tooltip" title="مشاهدة">
                          <i class="fa fa-eye"></i>
                        </a>
                        <a href="{{ route('editor.etudes.edit', $book->booksID) }}" class="btn btn-success btn-xs"
                        ...
                        <a href="{{ route('editor.pages.etudesPart', $book->booksID) }}" class="btn btn-primary btn-xs"
