      ...
      <div class="row">
        <div class="col-md-7">
          <div class="ltn__top-bar-menu">
            <ul>
              <li><a href="{{ route('client.about') }}"><i class="fa fa-home"></i>
                  من نحن</a></li>
                ...
                <nav>
                  <div class="ltn__main-menu">
                    <ul>
                      ...
                      <li><a href="{{ route('client.books') }}"> الأرشيف</a></li>
                ...
                <div class="ltn__drop-menu user-menu">
                  <ul>
                    <li style="margin-left:3px">
                      ...
                      <ul>
                        <li><a href="{{ route('client.pages.favoris') }}"> المواد المفضلة</a></li>

                        <li><a href="{{ route('logoutClient') }}">تسجيل الخروج</a></li>
                      </ul>
                    </li>
                    <li style="margin-left:3px">
                      <a href="{{ route('client.books') }}"><i class="icon-search"></i></a>
                    </li>
