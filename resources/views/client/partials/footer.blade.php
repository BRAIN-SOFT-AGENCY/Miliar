                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="footer-address-info">
                                        <p><a href="mailto:info@miliar.org">info@client.org</a></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="footer-menu">
                            ...
                            <ul>
                                ...
                                @foreach($categories as $category)
                                    <li>
                                        <a href="{{ route('client.categoryID', ['category' => $category->categoryID])  }}">
                    ...
                    <div class="footer-widget footer-menu-widget clearfix">
                        ...
                        <div class="footer-menu">
                            <ul>
                                ...
                                <li><a href="{{ route('client.pages.favoris') }}">قائمة الرغبات</a></li>
                                    ...
                                    <div id="mc_embed_signup_scroll">
                                        <div class="mc-field-group">
                                            <input type="email" value="" name="EMAIL" class="required email"
                                                id="mce-EMAIL" placeholder="بريد إلكتروني*">
                                        </div>
                                        ...
                                        <div class="clear">
                                            <div class="btn-wrapper">
                                                <button class="submitsearch" type="submit" value="Subscribe"
