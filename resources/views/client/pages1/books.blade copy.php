                            ...
                            <ul class="filter-bar">
                                ...
                                <li>
                                    <div class="short-by text-center">
                                        <form method="GET" action="{{ route('client.books') }}" id="sortForm">
                    ...
                    <div class="col-lg-4  mb-120">
                        <aside class="sidebar ltn__shop-sidebar">
                            <div class="widget ltn__search-widget">
                                <h4 class="ltn__widget-title ltn__widget-title-border">النوع</h4>

                                <div class="checkbox-group custom-checkbox">
                                    <form id="filterForm" method="GET" action="{{ route('client.books') }}"></form>
                            ...
                            <div class="widget ltn__search-widget">
                                <h4 class="ltn__widget-title ltn__widget-title-border">المصدر </h4>
                                <form action="{{ route('client.books') }}" method="GET">
                            ...
                            <div class="widget ltn__price-filter-widget">
                                <h4 class="ltn__widget-title ltn__widget-title-border">سنة الترجمة</h4>
                            ...
                            <div class="widget ltn__search-widget">
                                ...
                                <form action="{{ route('client.books') }}" method="GET" id="translatorForm">
                                    ...
                                    <select id="translatorSelect" name="translatorID">
                                        ...
                                        @foreach($translators as $translator)
                                            <option value="{{ $translator->translatorID }}" {{ request('translatorID') == $translator->translatorID ? 'selected' : '' }}>
                                ...
                                @push('scripts')
                                    <script>
                                        $(document).ready(function () {
                                            ...
                                            // submit auto
                                            $('#translatorSelect').on('change', function () {
