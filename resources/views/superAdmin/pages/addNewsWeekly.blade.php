      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <div class="box box-primary">
            <form action="{{ route('superAdmin.newsweekly.store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select id="week" name="week" class="form-control" required>
                    ...
                    @foreach(\App\Models\newsweekly::weekNames() as $weekNumber => $weekName)
                      <option value="{{ $weekNumber }}" @selected(old('week') == $weekNumber)>{{ $weekName }}</option>
                    @endforeach
                  </select>
                </div>
                <div class="form-group">
