                    ...
                    <div class="mb-4">
                      ...
                      <div class="d-flex justify-content-center gap-5 flex-wrap">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="partner" id="individual" value="0" checked>
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="partner" id="company" value="1">
