  ...
  <div class="content-wrapper">
    ...
    <script>
      ...
      function updateTotalWordCount() {
        let total = wordCounts.Titre + wordCounts.article + wordCounts.ResumeLivre; // 🔥 extrait retiré
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          ...
          <div class="box box-primary">
            ...
            @endif
            <form action="{{ route('superAdmin.etudesPart.store') }}" method="POST" enctype="multipart/form-data">

              @csrf

              @if(request('allbooks') == 1)
                <input type="hidden" name="allbooks" value="1">
              @endif
