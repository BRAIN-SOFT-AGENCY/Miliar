                ...
                <div class="row" style="direction: ltr;">
                    ...
                    <div class="col-lg-9 order-lg-1" style="direction: rtl;">
                        <div class="modern-topbar">
                            ...
                            <div class="modern-count">

                                عرض {{ $books->count() }} لكل صفحة

                            </div>

                            <div class="modern-sort">

                                <form method="GET" action="{{ route('miliar.books') }}">
                                        ...
                                        <article class="article-card">
                                            ...
                                            <div class="article-content">
                                                ...
                                                <p class="article-desc">
                                                    ...
                                                    {{ \Illuminate\Support\Str::limit($book->ResumeLivre, 110, '...') }}
