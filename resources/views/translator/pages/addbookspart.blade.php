      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          ...
          <div class="box box-primary">
            ...
            <form action="{{ route('translator.bookspart.store') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="booksPartTitre" class="form-control" required>
                    </div>
                    <div class="form-group">
                      <label>القسم</label>
                ...
                <div class="form-group">
                  ...
                  <textarea id="bookspartResumeLivre" name="bookspartResumeLivre" rows="4" class="form-control"
                    required></textarea>
                </div>
