                    ...
                    <div class="col-lg-4 col-md-6">
                          <div class="row">
                            <div class="col-lg-12">
                                <div class="section-title-area ltn__section-title-2--- text-center---">
                                    <h1 class="section-title-2 border-bottom"
                                        style="margin-bottom: 0px;font-size: 16px;                                                                                                                                                                                                                                                                                                                                                                                        text-align: center;                                                                                                                                                                                                                                                                                                                                                                                                                  border-right: 5px solid #442d66;
                                                                                                                                                                                                                                                                                                                                                                                                                    padding: 10px;    background: #fcfcf8;
                                                                                                                                                                                                                                                                                                                                                                                                                    color: #442d66;">
        ...
        <section class="stats-section" dir="rtl">
            ...
            <div class="stats-container">
                ...
                <div class="stat-card">
                    ...
                    <h3>{{ number_format($artcilescountlettre) }}</h3>
                    <small></small>
                    <p>عدد الحروف </p>
                </div>
            </div>
