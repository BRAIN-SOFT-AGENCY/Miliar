            ...
            <div class="container">
                @if($newsWeekly->isEmpty())
                    <div class="text-center" style="padding:40px 20px; border:1px solid #eee;">
                        ...
                        <h3>لا توجد نشرات أسبوعية لهذا الشهر</h3>
                    </div>
                @else
                    ...
                    <div class="ltn__cards-section">
                        <div class="container">
                            ...
                            <div class="ltn__cards-grid">
                                @foreach($newsWeekly as $row)
                                    <div class="ltn__book-card">
                                        <div class="ltn__book-card-img">

                                            <img src="{{ asset('includesAdmin/img/weekly/' . $row->picture) }}"
                                                alt="{{ $row->title }}">
                                        ...
                                        <div class="ltn__book-card-body">
                                            ...
                                            <div class="ltn__book-card-footer">
                                                <a href="{{ asset('includesAdmin/pdf/weekly/' . $row->pdf) }}" target="_blank"
                                                    class="read-btn">
                                                    اقرأ
                                                </a>
