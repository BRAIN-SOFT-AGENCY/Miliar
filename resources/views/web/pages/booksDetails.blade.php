...
@push('head')
    ...
    <meta name="description"
          content="{{ Str::limit(strip_tags($book->ResumeLivre), 160) }}">
    ...
    <meta property="og:description"
          content="{{ Str::limit(strip_tags($book->ResumeLivre), 200) }}">
    ...
    @if($book->Image)
        <meta property="og:image"
              content="{{ asset('assets/img/books/' . $book->Image) }}">
    @endif
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="article-header">
                            ...
                            <div class="article-meta">
                                ...
                                <!-- share -->
                                <span onclick="sharePage()" style="cursor: pointer;">
                                ...
                                <div style=" align-items: flex-start; gap: 20px;padding: 5px;">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-2 col-md-3">
                                            <a href="{{ route('miliar.booksDetails', $book->booksID) }}">
                                    ...
                                    <div class="book-section">
                                        ...
                                        <div style=" align-items: flex-start; gap: 20px;padding: 5px;">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-2 col-md-3">
                                                    <a href="{{ route('miliar.booksPartDetails', ['id' => $row->booksPartID]) }}">
                                                        <img src="{{ asset('includesAdmin/img/books/defaultPart.jpeg') }}"
                                                            alt="Image" style="width:30px;height:auto;">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="book-section">
                                        ...
                                        <div style=" align-items: flex-start; gap: 20px;padding: 5px;">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-2 col-md-3">
                                                    <a href="{{ route('miliar.etudesPartDetails', ['id' => $row->etudespartID]) }}">
                                                        <img src="{{ asset('includesAdmin/img/books/defaultPart.jpeg') }}"
                                                            alt="Image" style="width:30px;height:auto;">
                                                    </a>
                                                </div>
...
.article-image img {
    width: 100%;
    height: 100%;
    object-fit: cover;        /* don't stretch */
    object-position: center;  /* crop equally from sides/top */
    display: block;
}
...
function sharePage() {
    ...
    const title = @json($book->Titre);
    const description = @json(Str::limit(strip_tags($book->ResumeLivre), 200));
