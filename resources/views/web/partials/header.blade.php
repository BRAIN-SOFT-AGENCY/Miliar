      ...
      <div class="row">
        <div class="col-md-7">
          <div class="ltn__top-bar-menu">
            <ul>
              <li><a href="{{ route('miliar.about') }}"><i class="fa fa-home"></i>
                  من نحن</a></li>
...
?>
                      ...
                      <li><a href="https://www.facebook.com/share/1Eo6tCTXr6/" title="Facebook" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                      <li><a href="https://x.com/miliarorg?lang=ar" title="Twitter" target="_blank"><i class="fab fa-twitter"></i></a>
                      </li>

                      <li><a href="https://www.instagram.com/miliarorg?igsh=cTIwNjZrMng2cTg="  target="_blank" title="Instagram"><i class="fab fa-instagram"></i></a></li>
                      <li><a href="https://www.linkedin.com/showcase/miliarorg/" title="Dribbble" target="_blank"><i class="fab fa-linkedin"></i></a>
                      </li>
                    </ul>
                  </div>
                </li>
                ...
                <nav>
                  <div class="ltn__main-menu">
                    <ul>
                      ...
                      <li><a href="{{ route('miliar.translatorweb') }}"> المترجمين</a></li>
                      <li><a href="{{ route('miliar.elementor') }}"> دليل الجهات و المترجمين</a></li>
                ...
                <div class="ltn__drop-menu user-menu">
                  <ul>
                    <li style="margin-left:3px">
                      ...
                      <ul>
                        <li><a href="{{ route('miliar.inscription') }}" style="font-size: 14px;">تسجيل الدخول</a></li>
                        <li><a href="{{ route('miliar.demande') }}" style="font-size: 14px;">طلب إنضمام مترجم</a></li>
