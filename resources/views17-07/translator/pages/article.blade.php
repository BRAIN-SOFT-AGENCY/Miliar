      ...
      <div class="col-md-10" style="text-align: left;">
        <section>
          <div class="d-flex gap-2 justify-content-left">
            ...
            <a href="{{route('translator.pages.addArticle')}}" class="btn btn-success">
                ...
                <tbody>
                  ...
                  @foreach($books as $book)
                    ...
                    <tr>
                      ...
                      <td style="width: 150px !important;">{{ $book->Titre }}</td>
                      ...
                      <td style="display:flex; gap:5px; justify-content:center;">
                        <a href="{{ route('translator.article.view', $book->booksID) }}" class="btn btn-warning btn-xs"
                          data-toggle="tooltip" title="مشاهدة">
                          <i class="fa fa-eye"></i>
                        </a>
                        <a href="{{ route('translator.article.edit', $book->booksID) }}" class="btn btn-success btn-xs"
                        ...
                        <a href="{{ route('translator.article.delete', $book->booksID) }}" class="btn btn-danger btn-xs"
