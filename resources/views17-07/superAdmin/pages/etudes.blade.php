      ...
      <div class="col-md-10" style="text-align: left;">
        <section>
          <div class="d-flex gap-2 justify-content-left">
            ...
            <a href="{{route('superAdmin.pages.addEtudes')}}" class="btn btn-success">
                  ...
                  @foreach($books as $book)
                    ...
                    <tr>
                      ...
                      <td style="display:flex; gap:5px; justify-content:center;">
                        ...
                        <a href="{{ route('superAdmin.etudes.edit', $book->booksID) }}" class="btn btn-success btn-xs"
                          data-toggle="tooltip" title="تعديل">
                          <i class="fa fa-edit"></i>
                        </a>

                        <a href="{{ route('superAdmin.pages.etudesPart', $book->booksID) }}" class="btn btn-primary btn-xs"
