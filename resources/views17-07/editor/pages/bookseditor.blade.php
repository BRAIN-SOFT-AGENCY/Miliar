                  ...
                  @foreach($books as $book)
                    ...
                    <tr>
                      ...
                      <td style="display:flex; gap:5px; justify-content:center;">
                        ...
                        <a href="{{ route('editor.books.view', $book->booksID) }}" class="btn btn-warning btn-xs"
                          data-toggle="tooltip" title="مشاهدة">
                          <i class="fa fa-eye"></i>
                        </a>

                        <a href="{{ route('editor.books.edit', $book->booksID) }}" class="btn btn-success btn-xs"
                          data-toggle="tooltip" title="تعديل">
                          <i class="fa fa-edit"></i>
                        </a>
                        <form action="{{ route('editor.books.publish', $book->booksID) }}" method="POST" style="display:inline;">
                          @csrf
                        ...
                        <a href="{{ route('editor.pages.booksPart', $book->booksID) }}" class="btn btn-primary btn-xs"
