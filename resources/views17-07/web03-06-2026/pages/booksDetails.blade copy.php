                                ...
                                <div class="col-lg-6">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-2">
                                            ...
                                            {{ $book->translatorfirstName }} {{ $book->translatorLastName }}
                                        </li>

                                        <li class="mb-2">
                                            <strong>الخبرة:</strong>
                                            {{ $book->experience ?? 'خبرة في مجال الترجمة' }}
                                        </li>
                                ...
                                <div class="col-lg-6">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-2">
                                            ...
                                            {{ $book->location ?? 'الرياض، المملكة العربية السعودية' }}
                                        </li>
        ...
        <div class="ltn__small-product-list-area pt-10 pb-85">
            <div class="container">
                <div class="section-title-area ltn__section-title-2--- text-center">
                    <h1 class="section-title" style="    font-size: 30px;"> مقالات من نفس الصنف</h1>
                </div>
