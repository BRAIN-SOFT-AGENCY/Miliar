...
class AdminController extends Controller
{
    ...
    public function index()
    {
        // echo 'admin';
        // die();
        $books = Book::where('status', 0)->where('type', 1)->whereDate('books.PublierLe', '<=', now())->orderBy('booksID', 'desc')->get();
        // $cours = Book::where('status', 0)->where('type', 0)->whereDate('books.PublierLe', '<=', now())->orderBy('booksID', 'desc')->get();
	
		
		$coursCount = Book::where('status', 0)
    ->where('type', 0)
    ...
    ->get();
        ...
        $etudes = Book::where('status', 0)->where('type', 2)->whereDate('books.PublierLe', '<=', now())->orderBy('booksID', 'desc')->get();
        $toobooks = Book::where('status', -2)->where('type', 1)->take(2)->whereDate('books.PublierLe', '<=', now())->orderBy('booksID', 'desc')->get();
        $translators = Translator::withCount('books')->where('translator.translatorStatus', 1)->orderBy('books_count', 'desc')->take(9)->get();
        $allbooks = Book::where('status', -2)->take(4)->whereDate('books.PublierLe', '<=', now())->orderBy('booksID', 'desc')->get();
    ...
    public function addbanner()
    {
        ...
        return view('superAdmin.pages.addbanner', compact('books', 'translators', 'categories'));
    }
