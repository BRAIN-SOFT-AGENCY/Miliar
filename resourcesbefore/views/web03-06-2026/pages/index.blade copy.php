...
@section('content')
    <div class="body-wrapper">
                                                    ...
                                                    <div class="product-img overlay-style">
                                                        <a href="{{ route('miliar.booksDetails', ['id' => $row->booksID]) }}">
                                                            <img src="{{ asset('includesAdmin/img/books/' . $row->Image) }}"
                                                                style="width: 448px;" alt="{{ $row->Titre }}">
                                                        </a>

                                                        <!-- Overlay -->
                                                        <div class="overlay-content">
                                                            <span class="category">
                                                                {{ $row->categoryName ?? 'بدون تصنيف' }}
                                                            </span>
        ...
        <div class="ltn__slider-area ltn__slider-3---  section-bg-1--- mt-30" style="margin-top: 9px;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 bannerpicturedroite">
                        @foreach($bookBanner1 as $book)
                            <div class="bannerpicturepro3">

                                <div class="article-img overlay-style" style="height:382px;">
                                    <a href="{{ route('miliar.booksDetails', ['id' => $book->booksID]) }}">
                                        <img src="{{ asset('includesAdmin/img/books/' . $book->Image) }}" alt=""
                                            style="height:382px;">
                                    </a>
                            ...
                            <div class="tab-pane fade active show" id="liton_product_list">
                                <div class="ltn__product-tab-content-inner ltn__product-list-view">
                                    <div class="row g-1">
                                        ...
                                        @foreach($bookBanner as $row)
                                            <div class="col-lg-6 bannerpicturedroitelg6">
                                                <div class="">
