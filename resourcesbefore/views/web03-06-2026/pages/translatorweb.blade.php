...
@section('content')
    <div class="body-wrapper">
        ...
        <!-- BREADCRUMB AREA END -->
        <form method="GET" action="{{ route('miliar.translatorweb') }}" class="translator-search-form">

            <div class="search-box">

                <input type="text" name="search" placeholder="ابحث عن مترجم..." value="{{ request('search') }}">
                            ...
                            <div class="">
                                ...
                                <div class="">
                                    <img src="{{ asset('includesAdmin/img/translator/' . $translator->translatorPicture) }}"
                                        alt="Image" class="team-img-custom">
                                </div>

                                <!-- NAME -->
                                <h5 class="mt-3">
                                    <a href="{{ route('miliar.translatorDetails', ['id' => $translator->translatorID]) }}">
