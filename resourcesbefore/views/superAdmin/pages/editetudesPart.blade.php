        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="box box-primary">
                    ...
                    <form action="{{ route('superAdmin.etudes.updateetudesPart', $etudesPart->etudespartID) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="box-footer text-center">
                            ...
                            <a href="{{ route('superAdmin.pages.etudesPart',$etudesPart->booksID) }}" class="btn btn-default btn-lg">
