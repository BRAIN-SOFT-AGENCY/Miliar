      ...
      <div class="col-md-10" style="text-align: left;">
        <section>
          <div class="d-flex gap-2 justify-content-left">
              <a href="{{route('superAdmin.pages.addetudesPart', $booksID)}}?allbooks=1" class="btn btn-success">
                ...
                <tbody>
                  ...
                  @foreach($etudesPart as $book)
                    ...
                    <tr>
                      ...
                      <td>{{ $book->etudespartResumeLivre }}</td>
                      ...
                      <td style="display:flex; gap:5px; justify-content:center;">
                        <a href="{{ route('superAdmin.etudesPart.view', $book->etudespartID) }}"
                          class="btn btn-warning btn-xs" data-toggle="tooltip" title="مشاهدة">
                          <i class="fa fa-eye"></i>
                        </a>
                        <a href="{{ route('superAdmin.etudesPart.edit', $book->etudespartID) }}"
                          class="btn btn-success btn-xs" data-toggle="tooltip" title="تعديل">
                          <i class="fa fa-edit"></i>
                        </a>

                        <a href="{{ route('superAdmin.etudesPart.delete', $book->etudespartID) }}"
