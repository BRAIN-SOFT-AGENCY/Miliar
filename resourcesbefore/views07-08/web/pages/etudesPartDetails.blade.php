                ...
                <div class="row">
                        ...
                        <div class="custom-box custom-boxCateg">
                                ...
                                <div style=" align-items: flex-start; gap: 20px;padding: 5px;">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-2 col-md-3">
                                            <a href="{{ route('miliar.booksDetails', $bookoriginal->booksID) }}">
                            ...
                            @foreach($groupedBooks as $group)
                                @foreach($group as $row)
                                                ...
                                                <?php         
                                                                                              if ($row->etudespartID == $book->etudespartID) { ?>
                    ...
                    <div class="col-lg-9 order-lg-2 order-1">
                        ...
                        <div class="article-header">
                            ...
                            <div class="article-meta">
                                ...
                                <span>
                                    ...
                                    {{ $book->etudespartMaisonEdition }}
                                </span>

                                <span>
                                    <i class="far fa-calendar"></i>
                                    {{ \Carbon\Carbon::parse($book->etudespartPublierLe)->translatedFormat('d F Y') }}
                                </span>
                        ...
                        <div class="article-image">
                            ...
                            <img src="{{ asset('includesAdmin/img/books/' . $book->etudespartImage) }}"
                                alt="{{ $book->etudespartTitre }}">
