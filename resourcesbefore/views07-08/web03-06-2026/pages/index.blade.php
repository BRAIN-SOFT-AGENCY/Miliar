                    ...
                    <div class="tab-pane fade show active" id="tab2">
                                ...
                                @if($category1->count())
                                        ...
                                        ['id' => $firstBook->booksID]
                                                                ...
                                                                <div class="article-content">
                                                                    ...
                                                                    <h3 class="article-title" title="{{ $firstBook->Titre }}" style="margin-bottom: 0px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <a href="{{ route('miliar.books', ['category' => 1]) }}" class="buttonPlusIndex">
                    ...
                    <div class="tab-pane fade" id="tab3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <a href="{{ route('miliar.books', ['category' => 2]) }}" class="buttonPlusIndex">
                    ...
                    <div class="tab-pane fade" id="tab4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <a href="{{ route('miliar.books', ['category' => 3]) }}" class="buttonPlusIndex">
                    ...
                    <div class="tab-pane fade" id="tab5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <a href="{{ route('miliar.books', ['category' => 4]) }}" class="buttonPlusIndex">
                    ...
                    <div class="tab-pane fade" id="tab6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <a href="{{ route('miliar.books', ['category' => 6]) }}" class="buttonPlusIndex">
