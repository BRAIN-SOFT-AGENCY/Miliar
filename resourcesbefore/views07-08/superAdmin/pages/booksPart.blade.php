      ...
      <div class="col-md-10" style="text-align: left;">
        <section>
          <div class="d-flex gap-2 justify-content-left">
            ...
            <a href="{{route('superAdmin.pages.addbookspart', $booksID)}}" class="btn btn-success">
                  ...
                  @foreach($Bookspart as $book)
                    ...
                    <tr>
                      ...
                      <td style="display:flex; gap:5px; justify-content:center;">
                        <!-- VIEW -->
                        <a href="{{ route('superAdmin.bookspart.view', $book->booksPartID) }}"
                          class="btn btn-warning btn-xs" title="عرض">
                          <i class="fa fa-eye"></i>
                        </a>

                        <!-- EDIT -->
                        <a href="{{ route('superAdmin.bookspart.edit', $book->booksPartID) }}"
