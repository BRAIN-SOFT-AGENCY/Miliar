            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('includesAdmin/dist/img/user2-160x160.jpg') }}" class="user-image"
                            alt="User Image">
                        <span class="hidden-xs"> {{ Auth::guard('translator')->user()->translatorfirstName }}
                            {{ Auth::guard('translator')->user()->translatorLastName }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header" style="background-color: #303748 !important;">
                            <img src="{{ asset('includesAdmin/dist/img/user2-160x160.jpg') }}" class="img-circle"
                                alt="User Image">
                            <p>
                                {{ Auth::guard('translator')->user()->translatorfirstName }}
