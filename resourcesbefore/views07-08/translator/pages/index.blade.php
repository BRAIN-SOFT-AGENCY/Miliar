        ...
        <section class="col-md-7">
          ...
          <div class="box box-primary">
            ...
            <div class="box-header d-flex justify-content-between align-items-center">
              <h3 class="box-title">آخر الكتب المضافة</h3>
              <div>
                <a href="{{route('translator.pages.addbooks')}}" class="btn btn-success btn-sm" title="إضافة كتاب">
                  <i class="fa fa-plus"></i> إضافة كتاب
                </a>
              </div>
            </div>
        ...
        <section class="col-lg-12">
          ...
          <div class="box box-warning">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">
                <i class="fa fa-language"></i> آخر الترجمات
              </h3>
            </div>
