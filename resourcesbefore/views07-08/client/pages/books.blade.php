    ...
    <div class="wrapper">
                ...
                <div class="row" style="direction: ltr;">
                    <div class="col-lg-3 order-lg-2" style="direction: rtl;">
                        <aside class="sidebar ltn__shop-sidebar modern-sidebar-box">
                            ...
                            <form id="filterForm" method="GET" action="{{ route('client.books') }}">
                                                ...
                                                <article class="article-card">
                                                    ...
                                                    <div class="article-content">
                                                        ...
                                                        <h3 class="article-title">
                                                            ...
                                                            <a
                                                                href="{{ route('client.booksDetails', ['id' => $book->booksID]) }}">
                                                            ...
                                                            <div class="article-bookmark">
                                                                ...
                                                                @php
                                                                    ...
                                                                    if (session()->has('clientID')) {
                                                                        $isFavoris = \App\Models\Favoris::where('booksID', $book->booksID)
                                                                            ->where('clientID', session('clientID'))
                                                                            ->exists();
                                                                    }
                                                                @endphp
                                                                <a href="javascript:void(0)" class="btn-favoris"
                                                                    data-booksid="{{ $book->booksID }}">

                                                                    <i
                                                                        class="{{ $isFavoris ? 'fas text-danger' : 'far' }} fa-heart"></i>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.btn-favoris').click(function (e) {

                    e.preventDefault();

                    let button = $(this);
                    let icon = button.find('i');
                    let booksID = button.data('booksid');

                    $.ajax({

                        url: "{{ route('addFavoris') }}",
                        type: "POST",
